...
**`spec-brainstorming`** — it reads this `<slug>-research.md` and specifies the known, one
...
findings with **`spec-brainstorming`** (it reads this research and scales its dialogue to how much
