---
name: ddd-distilled
description: Distilled Domain-Driven Design decision and trigger rules (after Vernon's "DDD Distilled") — subdomains, bounded contexts, ubiquitous language, aggregates, domain events. LLM-derived and inspired by, NOT a reproduction of, the book. Use when designing a module, modeling a domain, or naming bounded contexts and aggregates.
---
