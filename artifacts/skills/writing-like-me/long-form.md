...
Put your long-form exemplars (essays, design docs, reports, anything over roughly 800 words) at one
of these paths, first hit wins:

1. `$PATRONUS_VOICE_DIR/long-form.md`, when that environment variable is set
2. `~/.claude/patronus/voice/long-form.md`, the default user-owned location
